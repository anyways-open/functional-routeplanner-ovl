        ...
        map.on("load", () => {
            ...
            map.addSource("gipod-con", {
                ...
                tiles: [
                    ...
                    "https://geo.api.vlaanderen.be/gipod/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image/png&TRANSPARENT=true&layers=GIPOD_WERK_VNDG&STYLES=default&&WIDTH=1905&HEIGHT=303&CRS=EPSG:3857&BBOX={bbox-epsg-3857}",
                ],
                tileSize: 256,
            });
            ...
            map.addSource("gipod-icon", {
                ...
                tiles: [
                    ...
                    "https://geo.api.vlaanderen.be/gipod/wms?SERVICE=WMS&REQUEST=GetMap&FORMAT=image/png&TRANSPARENT=TRUE&STYLES=default&VERSION=1.3.0&LAYERS=GIPOD_WERK_VNDG_ICOON&WIDTH=1905&HEIGHT=303&CRS=EPSG:3857&BBOX={bbox-epsg-3857}",
                ],
                tileSize: 256,
            });
